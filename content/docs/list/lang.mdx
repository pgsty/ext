...
|:-------:|:-----:|:------------|
| <a href="#c"><Badge icon={<FileCode2 />} variant="blue-subtle">C</Badge></a> | 335 | The traditional PostgreSQL extension language |
...
<a href="#c"><Badge icon={<FileCode2 />} variant="blue-subtle">C</Badge></a> <Badge icon={<Package />} variant="gray-subtle">335 Extensions</Badge>
