...
|:-------:|:-----:|:------------|
| <a href="#c"><Badge icon={<FileCode2 />} variant="blue-subtle">C</Badge></a> | 334 | The traditional PostgreSQL extension language |
| <a href="#sql"><Badge icon={<FileCode2 />} variant="green-subtle">SQL</Badge></a> | 37 | Pure SQL extensions and functions |
| <a href="#rust"><Badge icon={<FileCode2 />} variant="amber-subtle">Rust</Badge></a> | 33 | Extensions written in Rust with the pgrx framework |
| <a href="#data"><Badge icon={<FileCode2 />} variant="teal-subtle">Data</Badge></a> | 10 | Data-only extensions |
| <a href="#c--"><Badge icon={<FileCode2 />} variant="purple-subtle">C++</Badge></a> | 6 | Extensions leveraging C++ features and libraries |
| <a href="#python"><Badge icon={<FileCode2 />} variant="blue-subtle">Python</Badge></a> | 2 | Extensions written in Python |
| <a href="#java"><Badge icon={<FileCode2 />} variant="pink-subtle">Java</Badge></a> | 1 | Extensions running on JVM |


## C

<a href="#c"><Badge icon={<FileCode2 />} variant="blue-subtle">C</Badge></a> <Badge icon={<Package />} variant="gray-subtle">334 Extensions</Badge>
...
<a href="#sql"><Badge icon={<FileCode2 />} variant="green-subtle">SQL</Badge></a> <Badge icon={<Package />} variant="gray-subtle">37 Extensions</Badge>
...
<a href="#rust"><Badge icon={<FileCode2 />} variant="amber-subtle">Rust</Badge></a> <Badge icon={<Package />} variant="gray-subtle">33 Extensions</Badge>
...
<a href="#data"><Badge icon={<FileCode2 />} variant="teal-subtle">Data</Badge></a> <Badge icon={<Package />} variant="gray-subtle">10 Extensions</Badge>
...
<a href="#c--"><Badge icon={<FileCode2 />} variant="purple-subtle">C++</Badge></a> <Badge icon={<Package />} variant="gray-subtle">6 Extensions</Badge>
...
<a href="#python"><Badge icon={<FileCode2 />} variant="blue-subtle">Python</Badge></a> <Badge icon={<Package />} variant="gray-subtle">2 Extensions</Badge>
...
<a href="#java"><Badge icon={<FileCode2 />} variant="pink-subtle">Java</Badge></a> <Badge icon={<Package />} variant="gray-subtle">1 Extensions</Badge>
