...
| 语言 | 数量 | 描述 |
|:-------:|:-----:|:------------|
| <a href="#c"><Badge icon={<FileCode2 />} variant="blue-subtle">C</Badge></a> | 335 | C 语言， PostgreSQL 默认的扩展开发语言 |
...
<a href="#c"><Badge icon={<FileCode2 />} variant="blue-subtle">C</Badge></a> <Badge icon={<Package />} variant="gray-subtle">335 个扩展</Badge>
