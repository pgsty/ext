...
| 语言 | 数量 | 描述 |
|:-------:|:-----:|:------------|
| <a href="#c"><Badge icon={<FileCode2 />} variant="blue-subtle">C</Badge></a> | 334 | C 语言， PostgreSQL 默认的扩展开发语言 |
| <a href="#sql"><Badge icon={<FileCode2 />} variant="green-subtle">SQL</Badge></a> | 37 | 纯 SQL 扩展和函数 |
| <a href="#rust"><Badge icon={<FileCode2 />} variant="amber-subtle">Rust</Badge></a> | 33 | 使用 pgrx 框架的 Rust 语言扩展 |
| <a href="#data"><Badge icon={<FileCode2 />} variant="teal-subtle">Data</Badge></a> | 10 | 仅数据的扩展 |
| <a href="#c--"><Badge icon={<FileCode2 />} variant="purple-subtle">C++</Badge></a> | 6 | 利用 C++ 特性和库的扩展 |
| <a href="#python"><Badge icon={<FileCode2 />} variant="blue-subtle">Python</Badge></a> | 2 | Python 语言编写的扩展 |
| <a href="#java"><Badge icon={<FileCode2 />} variant="pink-subtle">Java</Badge></a> | 1 | 运行在 JVM 上的扩展 |


## C

<a href="#c"><Badge icon={<FileCode2 />} variant="blue-subtle">C</Badge></a> <Badge icon={<Package />} variant="gray-subtle">334 个扩展</Badge>
...
<a href="#sql"><Badge icon={<FileCode2 />} variant="green-subtle">SQL</Badge></a> <Badge icon={<Package />} variant="gray-subtle">37 个扩展</Badge>
...
<a href="#rust"><Badge icon={<FileCode2 />} variant="amber-subtle">Rust</Badge></a> <Badge icon={<Package />} variant="gray-subtle">33 个扩展</Badge>
...
<a href="#data"><Badge icon={<FileCode2 />} variant="teal-subtle">Data</Badge></a> <Badge icon={<Package />} variant="gray-subtle">10 个扩展</Badge>
...
<a href="#c--"><Badge icon={<FileCode2 />} variant="purple-subtle">C++</Badge></a> <Badge icon={<Package />} variant="gray-subtle">6 个扩展</Badge>
...
<a href="#python"><Badge icon={<FileCode2 />} variant="blue-subtle">Python</Badge></a> <Badge icon={<Package />} variant="gray-subtle">2 个扩展</Badge>
...
<a href="#java"><Badge icon={<FileCode2 />} variant="pink-subtle">Java</Badge></a> <Badge icon={<Package />} variant="gray-subtle">1 个扩展</Badge>
