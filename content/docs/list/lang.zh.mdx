...
| 语言 | 数量 | 描述 |
|:-------:|:-----:|:------------|
| <a href="/list/lang#c"><Badge icon={<FileCode2 />} variant="blue-subtle">C</Badge></a> | 334 | C 语言， PostgreSQL 默认的扩展开发语言 |
| <a href="/list/lang#sql"><Badge icon={<FileCode2 />} variant="green-subtle">SQL</Badge></a> | 37 | 纯 SQL 扩展和函数 |
| <a href="/list/lang#rust"><Badge icon={<FileCode2 />} variant="amber-subtle">Rust</Badge></a> | 33 | 使用 pgrx 框架的 Rust 语言扩展 |
| <a href="/list/lang#data"><Badge icon={<FileCode2 />} variant="teal-subtle">Data</Badge></a> | 10 | 仅数据的扩展 |
| <a href="/list/lang#c-1"><Badge icon={<FileCode2 />} variant="purple-subtle">C++</Badge></a> | 6 | 利用 C++ 特性和库的扩展 |
| <a href="/list/lang#python"><Badge icon={<FileCode2 />} variant="blue-subtle">Python</Badge></a> | 2 | Python 语言编写的扩展 |
| <a href="/list/lang#java"><Badge icon={<FileCode2 />} variant="pink-subtle">Java</Badge></a> | 1 | 运行在 JVM 上的扩展 |


## C

<a href="/list/lang#c"><Badge icon={<FileCode2 />} variant="blue-subtle">C</Badge></a> <Badge icon={<Package />} variant="gray-subtle">334 个扩展</Badge>

C 语言， PostgreSQL 默认的扩展开发语言
...
<a href="/list/lang#sql"><Badge icon={<FileCode2 />} variant="green-subtle">SQL</Badge></a> <Badge icon={<Package />} variant="gray-subtle">37 个扩展</Badge>
...
<a href="/list/lang#rust"><Badge icon={<FileCode2 />} variant="amber-subtle">Rust</Badge></a> <Badge icon={<Package />} variant="gray-subtle">33 个扩展</Badge>

使用 pgrx 框架的 Rust 语言扩展
...
<a href="/list/lang#data"><Badge icon={<FileCode2 />} variant="teal-subtle">Data</Badge></a> <Badge icon={<Package />} variant="gray-subtle">10 个扩展</Badge>
...
<a href="/list/lang#c-1"><Badge icon={<FileCode2 />} variant="purple-subtle">C++</Badge></a> <Badge icon={<Package />} variant="gray-subtle">6 个扩展</Badge>
...
<a href="/list/lang#python"><Badge icon={<FileCode2 />} variant="blue-subtle">Python</Badge></a> <Badge icon={<Package />} variant="gray-subtle">2 个扩展</Badge>
...
<a href="/list/lang#java"><Badge icon={<FileCode2 />} variant="pink-subtle">Java</Badge></a> <Badge icon={<Package />} variant="gray-subtle">1 个扩展</Badge>
