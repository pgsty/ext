...
| 许可证 | 数量 | 参考 | 描述 |
|:--------|:-----:|:-----:|:------------|
| <a href="#postgresql" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">PostgreSQL</Badge></a> | 199 | [许可证文本](https://opensource.org/licenses/postgresql) | 基于 BSD 许可证的非常宽松的许可证，允许几乎无限制的自由使用。 |
| <a href="#apache-20" className="no-underline"><Badge icon={<Scale />} variant="green-subtle">Apache-2.0</Badge></a> | 69 | [许可证文本](https://opensource.org/licenses/Apache-2.0) | 带有专利保护和署名要求的宽松许可证。 |
| <a href="#mit" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">MIT</Badge></a> | 59 | [许可证文本](https://opensource.org/licenses/MIT) | 允许商业使用、修改和私人使用的宽松许可证。 |
| <a href="#bsd-3-clause" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">BSD 3-Clause</Badge></a> | 30 | [许可证文本](https://opensource.org/license/bsd-3-clause) | 带有署名和背书限制条款的宽松许可证。 |
| <a href="#bsd-2-clause" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">BSD 2-Clause</Badge></a> | 14 | [许可证文本](https://opensource.org/license/bsd-2-clause) | 需要署名但允许商业使用的宽松许可证。 |
| <a href="#gpl-20" className="no-underline"><Badge icon={<Scale />} variant="amber-subtle">GPL-2.0</Badge></a> | 14 | [许可证文本](https://opensource.org/licenses/GPL-2.0) | 要求衍生作品开源的强Copyleft许可证。 |
| <a href="#gpl-30" className="no-underline"><Badge icon={<Scale />} variant="amber-subtle">GPL-3.0</Badge></a> | 12 | [许可证文本](https://opensource.org/licenses/GPL-3.0) | 带有额外专利和硬件限制的强Copyleft许可证。 |
| <a href="#agpl-30" className="no-underline"><Badge icon={<Scale />} variant="red-subtle">AGPL-3.0</Badge></a> | 10 | [许可证文本](https://opensource.org/licenses/AGPL-3.0) | 扩展 GPL 覆盖网络分发软件的网络Copyleft许可证。 |
| <a href="#isc" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">ISC</Badge></a> | 5 | [许可证文本](https://opensource.org/licenses/ISC) | 类似于 MIT 的宽松许可证，允许商业使用和修改。 |
| <a href="#artistic" className="no-underline"><Badge icon={<Scale />} variant="green-subtle">Artistic</Badge></a> | 3 | [许可证文本](https://opensource.org/license/artistic-2-0) | 允许在特定分发要求下修改的Copyleft许可证。 |
| <a href="#timescale" className="no-underline"><Badge icon={<Scale />} variant="gray-subtle">Timescale</Badge></a> | 2 | [许可证文本](https://www.timescale.com/legal/licenses) | 对商业使用和分发有限制的专有许可证。 |
| <a href="#bsd-0-clause" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">BSD 0-Clause</Badge></a> | 2 | [许可证文本](https://opensource.org/license/0bsd) | 等同于公共领域的许可证，对使用没有限制。 |
| <a href="#lgpl-30" className="no-underline"><Badge icon={<Scale />} variant="amber-subtle">LGPL-3.0</Badge></a> | 2 | [许可证文本](https://opensource.org/licenses/LGPL-3.0) | 带有额外专利和硬件条款的弱Copyleft许可证。 |
| <a href="#mpl-20" className="no-underline"><Badge icon={<Scale />} variant="green-subtle">MPL-2.0</Badge></a> | 1 | [许可证文本](https://opensource.org/licenses/MPL-2.0) | 允许与专有组合的弱Copyleft许可证，文件级Copyleft。 |
| <a href="#lgpl-21" className="no-underline"><Badge icon={<Scale />} variant="amber-subtle">LGPL-2.1</Badge></a> | 1 | [许可证文本](https://opensource.org/licenses/LGPL-2.1) | 允许专有应用动态链接的弱Copyleft许可证。 |
...
<a href="#postgresql" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">PostgreSQL</Badge></a> <Badge icon={<Package />} variant="gray-subtle">199 个扩展</Badge>

[PostgreSQL 许可证文本](https://opensource.org/licenses/postgresql) : 基于 BSD 许可证的非常宽松的许可证，允许几乎无限制的自由使用。
...
| 5060 | [`ddlx`](/zh/e/ddlx) | [`pg_ddlx`](/zh/e/ddlx) | 提取数据库对象的DDL |
...
| 5200 | [`pg_cheat_funcs`](/zh/e/pg_cheat_funcs) | [`pg_cheat_funcs`](/zh/e/pg_cheat_funcs) | 一些超级实用的作弊函数 |
...
| 5180 | [`pg_orphaned`](/zh/e/pg_orphaned) | [`pg_orphaned`](/zh/e/pg_orphaned) | 处理孤儿文件的扩展插件 |
...
| 5090 | [`pg_readonly`](/zh/e/pg_readonly) | [`pg_readonly`](/zh/e/pg_readonly) | 将集群设置为只读 |
...
| 5150 | [`pg_upless`](/zh/e/pg_upless) | [`pg_upless`](/zh/e/pg_upless) | 检测表上的无用UPDATE |
...
| 5170 | [`pgcozy`](/zh/e/pgcozy) | [`pgcozy`](/zh/e/pgcozy) | 根据先前的pg_buffercache快照预热内存缓冲区 |
...
| 5140 | [`pre_prepare`](/zh/e/pre_prepare) | [`preprepare`](/zh/e/pre_prepare) | 在服务端预先准备好PreparedStatement备用 |
| 3500 | [`prefix`](/zh/e/prefix) | [`pg_prefix`](/zh/e/prefix) | 前缀树数据类型 |
| 5070 | [`prioritize`](/zh/e/prioritize) | [`pg_prioritize`](/zh/e/prioritize) | 获取和设置 PostgreSQL 后端的优先级 |
...
<a href="#apache-20" className="no-underline"><Badge icon={<Scale />} variant="green-subtle">Apache-2.0</Badge></a> <Badge icon={<Package />} variant="gray-subtle">69 个扩展</Badge>

[Apache-2.0 许可证文本](https://opensource.org/licenses/Apache-2.0) : 带有专利保护和署名要求的宽松许可证。
...
| 5050 | [`pg_cooldown`](/zh/e/pg_cooldown) | [`pg_cooldown`](/zh/e/pg_cooldown) | 从缓冲区中移除特定关系的页面 |
...
<a href="#mit" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">MIT</Badge></a> <Badge icon={<Package />} variant="gray-subtle">59 个扩展</Badge>

[MIT 许可证文本](https://opensource.org/licenses/MIT) : 允许商业使用、修改和私人使用的宽松许可证。
...
| 5100 | [`pgdd`](/zh/e/pgdd) | [`pgdd`](/zh/e/pgdd) | 提供通过标准SQL查询数据库目录集簇的能力 |
...
<a href="#bsd-3-clause" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">BSD 3-Clause</Badge></a> <Badge icon={<Package />} variant="gray-subtle">30 个扩展</Badge>

[BSD 3-Clause 许可证文本](https://opensource.org/license/bsd-3-clause) : 带有署名和背书限制条款的宽松许可证。
...
| 5130 | [`pg_catcheck`](/zh/e/pg_catcheck) | [`pg_catcheck`](/zh/e/pg_catcheck) | 用于诊断系统目录是否损坏的工具 |
| 5190 | [`pg_crash`](/zh/e/pg_crash) | [`pg_crash`](/zh/e/pg_crash) | 向数据库进程随机发送信号模拟故障 |
| 5030 | [`pg_dirtyread`](/zh/e/pg_dirtyread) | [`pg_dirtyread`](/zh/e/pg_dirtyread) | 从表中读取尚未垃圾回收的行 |
...
| 5040 | [`pgfincore`](/zh/e/pgfincore) | [`pgfincore`](/zh/e/pgfincore) | 检查和管理操作系统缓冲区缓存 |
...
<a href="#bsd-2-clause" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">BSD 2-Clause</Badge></a> <Badge icon={<Package />} variant="gray-subtle">14 个扩展</Badge>

[BSD 2-Clause 许可证文本](https://opensource.org/license/bsd-2-clause) : 需要署名但允许商业使用的宽松许可证。
...
| 5110 | [`pg_permissions`](/zh/e/pg_permissions) | [`pg_permissions`](/zh/e/pg_permissions) | 查看对象权限并将其与期望状态进行比较 |
...
<a href="#gpl-20" className="no-underline"><Badge icon={<Scale />} variant="amber-subtle">GPL-2.0</Badge></a> <Badge icon={<Package />} variant="gray-subtle">14 个扩展</Badge>

[GPL-2.0 许可证文本](https://opensource.org/licenses/GPL-2.0) : 要求衍生作品开源的强Copyleft许可证。
...
<a href="#gpl-30" className="no-underline"><Badge icon={<Scale />} variant="amber-subtle">GPL-3.0</Badge></a> <Badge icon={<Package />} variant="gray-subtle">12 个扩展</Badge>

[GPL-3.0 许可证文本](https://opensource.org/licenses/GPL-3.0) : 带有额外专利和硬件限制的强Copyleft许可证。
...
<a href="#agpl-30" className="no-underline"><Badge icon={<Scale />} variant="red-subtle">AGPL-3.0</Badge></a> <Badge icon={<Package />} variant="gray-subtle">10 个扩展</Badge>

[AGPL-3.0 许可证文本](https://opensource.org/licenses/AGPL-3.0) : 扩展 GPL 覆盖网络分发软件的网络Copyleft许可证。
...
<a href="#isc" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">ISC</Badge></a> <Badge icon={<Package />} variant="gray-subtle">5 个扩展</Badge>

[ISC 许可证文本](https://opensource.org/licenses/ISC) : 类似于 MIT 的宽松许可证，允许商业使用和修改。
...
<a href="#artistic" className="no-underline"><Badge icon={<Scale />} variant="green-subtle">Artistic</Badge></a> <Badge icon={<Package />} variant="gray-subtle">3 个扩展</Badge>

[Artistic 许可证文本](https://opensource.org/license/artistic-2-0) : 允许在特定分发要求下修改的Copyleft许可证。
...
<a href="#timescale" className="no-underline"><Badge icon={<Scale />} variant="gray-subtle">Timescale</Badge></a> <Badge icon={<Package />} variant="gray-subtle">2 个扩展</Badge>

[Timescale 许可证文本](https://www.timescale.com/legal/licenses) : 对商业使用和分发有限制的专有许可证。
...
<a href="#bsd-0-clause" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">BSD 0-Clause</Badge></a> <Badge icon={<Package />} variant="gray-subtle">2 个扩展</Badge>

[BSD 0-Clause 许可证文本](https://opensource.org/license/0bsd) : 等同于公共领域的许可证，对使用没有限制。
...
<a href="#lgpl-30" className="no-underline"><Badge icon={<Scale />} variant="amber-subtle">LGPL-3.0</Badge></a> <Badge icon={<Package />} variant="gray-subtle">2 个扩展</Badge>

[LGPL-3.0 许可证文本](https://opensource.org/licenses/LGPL-3.0) : 带有额外专利和硬件条款的弱Copyleft许可证。
...
<a href="#mpl-20" className="no-underline"><Badge icon={<Scale />} variant="green-subtle">MPL-2.0</Badge></a> <Badge icon={<Package />} variant="gray-subtle">1 个扩展</Badge>

[MPL-2.0 许可证文本](https://opensource.org/licenses/MPL-2.0) : 允许与专有组合的弱Copyleft许可证，文件级Copyleft。
...
<a href="#lgpl-21" className="no-underline"><Badge icon={<Scale />} variant="amber-subtle">LGPL-2.1</Badge></a> <Badge icon={<Package />} variant="gray-subtle">1 个扩展</Badge>

[LGPL-2.1 许可证文本](https://opensource.org/licenses/LGPL-2.1) : 允许专有应用动态链接的弱Copyleft许可证。
