...
| 许可证 | 数量 | 参考文本 | 描述 |
|:--------|:-----:|:-----:|:------------|
| <a href="#postgresql" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">PostgreSQL</Badge></a> | 200 | [许可证](https://opensource.org/licenses/postgresql) | 基于 BSD 许可证的非常宽松的许可证，允许几乎无限制的自由使用。 |
...
<a href="#postgresql" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">PostgreSQL</Badge></a> <Badge icon={<Package />} variant="gray-subtle">200 个扩展</Badge>
