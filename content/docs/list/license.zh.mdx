...
| 许可证 | 数量 | 参考文本 | 描述 |
|:--------|:-----:|:-----:|:------------|
| <a href="#postgresql" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">PostgreSQL</Badge></a> | 199 | [许可证](https://opensource.org/licenses/postgresql) | 基于 BSD 许可证的非常宽松的许可证，允许几乎无限制的自由使用。 |
| <a href="#apache-20" className="no-underline"><Badge icon={<Scale />} variant="green-subtle">Apache-2.0</Badge></a> | 69 | [许可证](https://opensource.org/licenses/Apache-2.0) | 带有专利保护和署名要求的宽松许可证。 |
| <a href="#mit" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">MIT</Badge></a> | 59 | [许可证](https://opensource.org/licenses/MIT) | 允许商业使用、修改和私人使用的宽松许可证。 |
| <a href="#bsd-3-clause" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">BSD 3-Clause</Badge></a> | 30 | [许可证](https://opensource.org/license/bsd-3-clause) | 带有署名和背书限制条款的宽松许可证。 |
| <a href="#bsd-2-clause" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">BSD 2-Clause</Badge></a> | 14 | [许可证](https://opensource.org/license/bsd-2-clause) | 需要署名但允许商业使用的宽松许可证。 |
| <a href="#gpl-20" className="no-underline"><Badge icon={<Scale />} variant="amber-subtle">GPL-2.0</Badge></a> | 14 | [许可证](https://opensource.org/licenses/GPL-2.0) | 要求衍生作品开源的强Copyleft许可证。 |
| <a href="#gpl-30" className="no-underline"><Badge icon={<Scale />} variant="amber-subtle">GPL-3.0</Badge></a> | 12 | [许可证](https://opensource.org/licenses/GPL-3.0) | 带有额外专利和硬件限制的强Copyleft许可证。 |
| <a href="#agpl-30" className="no-underline"><Badge icon={<Scale />} variant="red-subtle">AGPL-3.0</Badge></a> | 10 | [许可证](https://opensource.org/licenses/AGPL-3.0) | 扩展 GPL 覆盖网络分发软件的网络Copyleft许可证。 |
| <a href="#isc" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">ISC</Badge></a> | 5 | [许可证](https://opensource.org/licenses/ISC) | 类似于 MIT 的宽松许可证，允许商业使用和修改。 |
| <a href="#artistic" className="no-underline"><Badge icon={<Scale />} variant="green-subtle">Artistic</Badge></a> | 3 | [许可证](https://opensource.org/license/artistic-2-0) | 允许在特定分发要求下修改的Copyleft许可证。 |
| <a href="#timescale" className="no-underline"><Badge icon={<Scale />} variant="gray-subtle">Timescale</Badge></a> | 2 | [许可证](https://www.timescale.com/legal/licenses) | 对商业使用和分发有限制的专有许可证。 |
| <a href="#bsd-0-clause" className="no-underline"><Badge icon={<Scale />} variant="blue-subtle">BSD 0-Clause</Badge></a> | 2 | [许可证](https://opensource.org/license/0bsd) | 等同于公共领域的许可证，对使用没有限制。 |
| <a href="#lgpl-30" className="no-underline"><Badge icon={<Scale />} variant="amber-subtle">LGPL-3.0</Badge></a> | 2 | [许可证](https://opensource.org/licenses/LGPL-3.0) | 带有额外专利和硬件条款的弱Copyleft许可证。 |
| <a href="#mpl-20" className="no-underline"><Badge icon={<Scale />} variant="green-subtle">MPL-2.0</Badge></a> | 1 | [许可证](https://opensource.org/licenses/MPL-2.0) | 允许与专有组合的弱Copyleft许可证，文件级Copyleft。 |
| <a href="#lgpl-21" className="no-underline"><Badge icon={<Scale />} variant="amber-subtle">LGPL-2.1</Badge></a> | 1 | [许可证](https://opensource.org/licenses/LGPL-2.1) | 允许专有应用动态链接的弱Copyleft许可证。 |
...
[PostgreSQL 许可证](https://opensource.org/licenses/postgresql) : 基于 BSD 许可证的非常宽松的许可证，允许几乎无限制的自由使用。
...
[Apache-2.0 许可证](https://opensource.org/licenses/Apache-2.0) : 带有专利保护和署名要求的宽松许可证。
...
[MIT 许可证](https://opensource.org/licenses/MIT) : 允许商业使用、修改和私人使用的宽松许可证。
...
[BSD 3-Clause 许可证](https://opensource.org/license/bsd-3-clause) : 带有署名和背书限制条款的宽松许可证。
...
[BSD 2-Clause 许可证](https://opensource.org/license/bsd-2-clause) : 需要署名但允许商业使用的宽松许可证。
...
[GPL-2.0 许可证](https://opensource.org/licenses/GPL-2.0) : 要求衍生作品开源的强Copyleft许可证。
...
[GPL-3.0 许可证](https://opensource.org/licenses/GPL-3.0) : 带有额外专利和硬件限制的强Copyleft许可证。
...
[AGPL-3.0 许可证](https://opensource.org/licenses/AGPL-3.0) : 扩展 GPL 覆盖网络分发软件的网络Copyleft许可证。
...
[ISC 许可证](https://opensource.org/licenses/ISC) : 类似于 MIT 的宽松许可证，允许商业使用和修改。
...
[Artistic 许可证](https://opensource.org/license/artistic-2-0) : 允许在特定分发要求下修改的Copyleft许可证。
...
[Timescale 许可证](https://www.timescale.com/legal/licenses) : 对商业使用和分发有限制的专有许可证。
...
[BSD 0-Clause 许可证](https://opensource.org/license/0bsd) : 等同于公共领域的许可证，对使用没有限制。
...
[LGPL-3.0 许可证](https://opensource.org/licenses/LGPL-3.0) : 带有额外专利和硬件条款的弱Copyleft许可证。
...
[MPL-2.0 许可证](https://opensource.org/licenses/MPL-2.0) : 允许与专有组合的弱Copyleft许可证，文件级Copyleft。
...
[LGPL-2.1 许可证](https://opensource.org/licenses/LGPL-2.1) : 允许专有应用动态链接的弱Copyleft许可证。
