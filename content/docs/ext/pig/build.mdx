...
- [**EL distributions**](/ext/repo): RHEL, Rocky, CentOS (tested on versions 8 and 9)
- [**DEB distributions**](/ext/repo): Debian (tested on versions 12), Ubuntu (tested on versions 22.04 and 24.04)
