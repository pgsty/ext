...
Extensions ([Package Alias](/ext/usage/pkg)) listed in [`pg_extensions`](/docs/pgsql/param#pg_extensions) will be upgraded with [`pgsql.yml`](/docs/pgsql/admin/)'s `pg_ext` subtask:
...
Pigsty’s [`pig`](/ext/pig/) cli can also help you with that, without the burden of specifying full package names:
