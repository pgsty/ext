...
There are unparalleled [**420+**](/ext/list) extensions available in Pigsty for 10 mainstream [Linux distros](/docs/prepare/linux).

--------

## Overview

It takes 4 steps to deliver an extension: [**downloads**](/ext/usage/download), [**installs**](/ext/usage/install), [**config**](/ext/usage/config), and [**create**](/ext/usage/create):
