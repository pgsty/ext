...
|:--------:|:--------:|:----------:|:--------------:|:---------------------------------------:|:------------------------------------------------------:|:----:|
| **3220** | [`dbt2`](https://github.com/osdldbt/dbt2) | `dbt2` | 0.45.0 | <a href="/ext/lang" className="no-underline"><Badge icon={<BookA />} variant="teal-subtle">LANG</Badge></a> | <a href="/ext/list/license#artistic" className="no-underline"><Badge icon={<Scale />} variant="green-subtle">Artistic</Badge></a> | <a href="/ext/list/lang#c"><Badge icon={<FileCode2 />} variant="blue-subtle">C</Badge></a> |
...
|:----------:|:--------:|:------------------------:|:-----------:|:------------:|:------------------:|
|   **EL**   | <Badge variant="blue-subtle"><span className="font-bold">PGDG</span></Badge> | `dbt2-pg$v-extensions*` | `0.45.0` | - | <Badge variant="green-subtle">17</Badge><Badge variant="green-subtle">16</Badge><Badge variant="green-subtle">15</Badge><Badge variant="green-subtle">14</Badge><Badge variant="green-subtle">13</Badge> |
...
```
```bash tab="ansible"
./pgsql.yml -t pg_ext -e '{"pg_extensions": ["dbt2"]}' # -l <cls>
```
