...
To install postgres extensions, you’ll have to add the [**repo**](https://pigsty.io/ext/pig/repo/) first:
...
Check [**extension list**](https://pigsty.io/ext/list/) for available extensions and their names.
