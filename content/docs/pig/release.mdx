...
You can install PostgreSQL Kernels along with & [**404 extensions**](https://pigsty.io/ext/list) with a simple command. Besides, pig v0.3 is also embedded & shipped with the latest Pigsty [v3.3.0](https://pigsty.io/docs/releasenote#v330).
...
[![ecosystem](/img/ecosystem.gif)](https://pigsty.io/about/ext)
...
[Install](https://pigsty.io/ext/pig/releasenote/#installation) the `pig` package first, you can also install via [apt/yum](https://pigsty.io/ext/pig/releasenote/#installation) command.
...
Check the [advanced usage](https://pigsty.io/ext/pig/releasenote/#advanced-usage) for details and [list 340 available extensions](https://ext.pigsty.io/#/list).
