...
|:---------------:|:----------:|--------------------------------------|------------------------------------------------------------|
| [v0.5.0](#v050) | 2025-06-30 | 422 extension, routine fix           | [v0.5.0](https://github.com/pgsty/pig/releases/tag/v0.5.0) |
...
| [v0.4.0](#v040) | 2025-05-0? | do & pt sub-cmd, halo & orioledb     | [v0.4.0](https://github.com/pgsty/pig/releases/tag/v0.4.0) |
...
- The brand-new extension catalog website: https://ext.pgsty.com
- Update the extension list to 423 (with pg_tde / orioledb)
- Add percona postgres kernel alias (with pg_tde support)
- New subcommand `pig install` which is a wrapper for `pig sty install`
- Update extension info output
...
List of [**405**](/list) PG extensions:
...
The [`pig`](/pig/) project now has a new [homepage](/pig/), alone with the PostgreSQL Extension [Catalog](/list).
...
You can install PostgreSQL Kernels along with & [**404 extensions**](/list) with a simple command. Besides, pig v0.3 is also embedded & shipped with the latest Pigsty [v3.3.0](https://pigsty.io/docs/releasenote#v330).

**New Features**

`pig build` subcommand with the [ability](/pig/build/) to setup extension building environment
...
[Install](/pig/releasenote/#installation) the `pig` package first, you can also install via [apt/yum](/pig/releasenote/#installation) command.
...
Check the [advanced usage](/pig/releasenote/#advanced-usage) for details and [list 340 available extensions](/list/).
