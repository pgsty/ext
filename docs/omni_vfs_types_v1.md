...
> [omnigres](https://github.com/omnigres/omnigres): Virtual File System types (v1)
>
...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omni_vfs_types_v1](https://github.com/omnigres/omnigres) | 0.1.0 | **<span class="tccyan">Apache-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [omnigres](/omni_vfs_types_v1) |  | `omni_vfs_types_v1` | [`omni_vfs_types_v1`](omni_vfs_types_v1), [`dblink`](dblink) | [`omni_vfs_types_v1`](/omni_vfs_types_v1) |
...
Install `omni_vfs_types_v1` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add omni_vfs_types_v1
```
