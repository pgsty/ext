...
> [omnigres](https://github.com/omnigres/omnigres): Programmatic SQL manipulation
>
...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omni_sql](https://github.com/omnigres/omnigres) | 0.5.1 | **<span class="tccyan">Apache-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [omnigres](/omni_sql) |  | `omni_sql` |  | [`omni_rest`](/omni_rest), [`omni_schema`](/omni_schema) |
...
Install `omni_sql` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add omni_sql
```
