...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omni_polyfill](https://docs.omnigres.org/omni_polyfill/polyfills/) | 0.2.2 | **<span class="tccyan">Apache-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [omnigres](/omni_polyfill) |  | `omni_polyfill` |  | [`omni_auth`](/omni_auth), [`omni_email`](/omni_email), [`omni_ledger`](/omni_ledger), [`omni_session`](/omni_session) |
...
Install `omni_polyfill` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add omni_polyfill
```
