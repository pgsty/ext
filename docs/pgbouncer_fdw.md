...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [pgbouncer_fdw](https://github.com/CrunchyData/pgbouncer_fdw) | 1.4.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tccyan">PGDG</span>** |  | `SQL` |
...
|:--:|---------|:-------:|:----:|-----------------|:--:|:--:|:--:|:--:|:--:|------------|
| [RPM](/rpm) | 1.4.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tccyan">PGDG</span>** | `pgbouncer_fdw_$v` | **<span class="tccyan">✔</span>** | **<span class="tccyan">✔</span>** | **<span class="tccyan">✔</span>** | **<span class="tccyan">✔</span>** | **<span class="tccyan">✔</span>** |  |



Install `pgbouncer_fdw` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add pgbouncer_fdw
```
