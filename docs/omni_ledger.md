...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omni_ledger](https://docs.omnigres.org/omni_ledger/basics/) | 0.1.2 | **<span class="tccyan">Apache-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [omnigres](/omni_ledger) |  | `omni_ledger` | [`omni_id`](omni_id), [`omni_polyfill`](omni_polyfill) |  |
...
Install `omni_ledger` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add omni_ledger
```
