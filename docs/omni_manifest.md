...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omni_manifest](https://docs.omnigres.org/omni_manifest/usage/) | 0.1.2 | **<span class="tccyan">Apache-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [omnigres](/omni_manifest) |  | `omni_manifest` |  |  |
...
Install `omni_manifest` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add omni_manifest
```
