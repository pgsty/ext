...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omni_httpc](https://docs.omnigres.org/omni_httpc/reference/) | 0.1.5 | **<span class="tccyan">Apache-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [omnigres](/omni_httpc) |  | `omni_httpc` | [`omni_http`](omni_http), [`omni_types`](omni_types) | [`omni_aws`](/omni_aws), [`omni_containers`](/omni_containers), [`omni_kube`](/omni_kube) |
...
Install `omni_httpc` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add omni_httpc
```
