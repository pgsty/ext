...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omni_rest](https://docs.omnigres.org/omni_rest/protocols/) | 0.1.1 | **<span class="tccyan">Apache-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [omnigres](/omni_rest) |  | `omni_rest` | [`omni_httpd`](omni_httpd), [`omni_sql`](omni_sql), [`omni_web`](omni_web), [`omni_var`](omni_var), [`pgcrypto`](pgcrypto) |  |
...
Install `omni_rest` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add omni_rest
```
