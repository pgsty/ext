...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omni_types](https://docs.omnigres.org/omni_types/function_signature_types/) | 0.3.4 | **<span class="tccyan">Apache-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [omnigres](/omni_types) |  | `omni_types` |  | [`omni_auth`](/omni_auth), [`omni_httpc`](/omni_httpc), [`omni_httpd`](/omni_httpd) |
...
Install `omni_types` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add omni_types
```
