...
> [omnigres](https://docs.omnigres.org/omni_session/session_management/): Session management
>
> https://docs.omnigres.org/omni_session/session_management/
...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omni_session](https://docs.omnigres.org/omni_session/session_management/) | 0.2.0 | **<span class="tccyan">Apache-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [omnigres](/omni_session) |  | `omni_session` | [`omni_var`](omni_var), [`omni_id`](omni_id), [`omni_web`](omni_web), [`omni_httpd`](omni_httpd), [`omni_polyfill`](omni_polyfill) |  |
...
Install `omni_session` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add omni_session
```
