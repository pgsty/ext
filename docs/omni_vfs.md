...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omni_vfs](https://docs.omnigres.org/omni_vfs/reference/) | 0.2.1 | **<span class="tccyan">Apache-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [omnigres](/omni_vfs) |  | `omni_vfs` |  | [`omni_schema`](/omni_schema) |
...
Install `omni_vfs` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add omni_vfs
```
