...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omni_test](https://docs.omnigres.org/omni_test/guide/) | 0.4.0 | **<span class="tccyan">Apache-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [omnigres](/omni_test) |  | `omni_test` | [`dblink`](dblink) |  |
...
Install `omni_test` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add omni_test
```
