...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omni_id](https://docs.omnigres.org/omni_id/identity_type/) | 0.4.2 | **<span class="tccyan">Apache-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [omnigres](/omni_id) |  |  |  | [`omni_auth`](/omni_auth), [`omni_email`](/omni_email), [`omni_ledger`](/omni_ledger), [`omni_session`](/omni_session) |
...
Install `omni_id` via the [`pig`](https://github.com/pgsty/pig) cli tool:
