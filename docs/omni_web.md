...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omni_web](https://docs.omnigres.org/omni_web/intro/) | 0.3.0 | **<span class="tccyan">Apache-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [omnigres](/omni_web) |  | `omni_web` |  | [`omni_aws`](/omni_aws), [`omni_cloudevents`](/omni_cloudevents), [`omni_containers`](/omni_containers), [`omni_kube`](/omni_kube), [`omni_rest`](/omni_rest), [`omni_session`](/omni_session) |
...
Install `omni_web` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add omni_web
```
